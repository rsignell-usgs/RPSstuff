function theResult = maxfilt(theData, theFilterLength, theChunkLength)
% Maxfilt -- Maximum-filtering.
%  maxfilt(theData, theFilterLength, theChunkLength) applies
...
if isequal(theData, 'demo')
        ...
        theFilterLength = 3
        theChunkLength = 5
        result = maxfilt(theData, theFilterLength, theChunkLength)
        return
end
...
function theResult = mxfilt(theData, theFilterLength)

% mxfilt -- Maximum filter.
%  mxfilt(theData, theFilterLength) applies a centered
...
if isequal(theData, 'demo')
        ...
        theFilterLength = 3
        theFilteredData = mxfilt(theData, theFilterLength)
        return
end
